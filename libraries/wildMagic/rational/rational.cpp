...
RationalException::RationalException(const char * reason) : r(reason) {}
RationalException::RationalException(const std::string & reason) : r(reason) {}
RationalException::~RationalException() throw() {}
const char * RationalException::what() const throw() { return r.c_str(); }
