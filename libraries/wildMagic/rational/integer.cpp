...
IntegerException::IntegerException(const char * reason) : r(reason) {}
IntegerException::IntegerException(const std::string & reason) : r(reason) {}
IntegerException::~IntegerException() throw() {}
const char * IntegerException::what() const throw() { return r.c_str(); }
