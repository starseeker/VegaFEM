...
int ObjMeshGPUDeformer_coarseToFine_fbo::InitRTT()
{
  if (InitExtensions() != 0)
  {
...
void ObjMeshGPUDeformer_coarseToFine_fbo::BindDynamicTextureToFBO()
{
  printf("****  Binding texture %d to fbo %d\n", vertexDeformationTextureID, fbo);
  glBindFramebufferEXT(GL_FRAMEBUFFER_EXT, fbo);
  glFramebufferTexture2DEXT(GL_FRAMEBUFFER_EXT, GL_COLOR_ATTACHMENT0_EXT, GL_TEXTURE_2D, vertexDeformationTextureID, 0);
  CheckFramebufferStatus();
  glBindFramebufferEXT(GL_FRAMEBUFFER_EXT, 0);
}

void ObjMeshGPUDeformer_coarseToFine_fbo::EnableRTT()
{
  glBindFramebufferEXT(GL_FRAMEBUFFER_EXT, fbo);
  glFramebufferTexture2DEXT(GL_FRAMEBUFFER_EXT, GL_COLOR_ATTACHMENT0_EXT, GL_TEXTURE_2D, vertexDeformationTextureID, 0);
}

void ObjMeshGPUDeformer_coarseToFine_fbo::DisableRTT()
{
  glBindFramebufferEXT(GL_FRAMEBUFFER_EXT, 0);
}

void ObjMeshGPUDeformer_coarseToFine_fbo::BindRT()
{
}

void ObjMeshGPUDeformer_coarseToFine_fbo::UnbindRT()
{
}

void ObjMeshGPUDeformer_coarseToFine_fbo::CheckFramebufferStatus()
{
    GLenum status;
...
void ObjMeshGPUDeformer_coarseToFine_fbo::SetDerivedData(void * data) 
{ 
  fbo = *(int*)data; 
  BindDynamicTextureToFBO();
}
